...
print("score r^2 (train)", reg.score(ages_train, net_worths_train))
print("score r^2 (test)", reg.score(ages_test, net_worths_test))
...
if len(cleaned_data) > 0:
    ...
    try:
        ...
        print("cleaned score r^2 (test)", reg.score(ages_test, net_worths_test))
